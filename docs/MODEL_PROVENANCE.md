...
This model is not committed to the repository. It was used only to validate the local macOS package.
...
- License or model card: verify OpenAI Whisper and Hugging Face artifact terms before redistribution
- Redistribution allowed: not asserted here
- License/model card included in bundle: no, not release-ready
